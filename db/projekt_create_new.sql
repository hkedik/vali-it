...
ALTER TABLE group_balance ADD CONSTRAINT school_class_balance_group_info
...
ALTER TABLE user_in_group ADD CONSTRAINT user_in_school_class_group_info
    FOREIGN KEY (group_info_id)
    REFERENCES group_info (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE user_in_group ADD CONSTRAINT user_in_school_class_user
    FOREIGN KEY (user_id)
    REFERENCES "user" (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
